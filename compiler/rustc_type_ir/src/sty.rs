...
{
    fn decode(__decoder: &mut __D) -> Result<Self, <__D as rustc_serialize::Decoder>::Error> {
        __decoder.read_enum(|__decoder| {
            __decoder.read_enum_variant(
                ...
                |__decoder, __variant_idx| {
                    ...
                    Ok(match __variant_idx {
                        ...
                        2 => {
                            Int(__decoder
                                .read_enum_variant_arg(rustc_serialize::Decodable::decode)?)
                        }
                        3 => Uint(
                        ...
                        _ => {
                            return Err(rustc_serialize::Decoder::error(
                                __decoder,
                                &format!(
