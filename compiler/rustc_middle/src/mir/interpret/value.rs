...
impl<'tcx, Tag: Provenance> Scalar<Tag> {
    ...
    #[inline]
    fn to_unsigned_with_bit_width(self, bits: u64) -> InterpResult<'tcx, u128> {
    ...
    #[inline]
    fn to_signed_with_bit_width(self, bits: u64) -> InterpResult<'tcx, i128> {
        let sz = Size::from_bits(bits);
...
impl<Tag> ScalarMaybeUninit<Tag> {
    ...
    #[inline]
    pub fn check_init(self) -> InterpResult<'tcx, Scalar<Tag>> {
        match self {
